...
public class StationCtrl extends Controller {
   ...
   * @param windDirection
   * @param pressure
   * @param timeStamp     once created it is added to the readings ArrayList
   */
   ...
   *
   * @param id
   * @param readingid reading is found and subsequently removed from the reading ArrayList and deleted
   */
