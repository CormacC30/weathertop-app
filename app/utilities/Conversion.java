...
public class Conversion {
   ...
   *
   * @param windSpeed checks if the windspeed value falls within a certain range on Beaufort Scale
   ...
   *
   * @param code Switch statement returns a corresponding String weather descriptor.
   * @return
   */
   ...
   * takes in
   *
   * @param windDirection checks if it falls within a range, corresponding with compass direction
   ...
   *
   * @param temperature
   * @param windSpeed   Performs wind chill calculation and
   ...
   *
   * @param temperature The method uses if statements to test if the celcius temperature falls within a temperature range
   *                    Then
   ...
   *
   * @param date this comes either from the localDateTime.now() method (for new readings) or from data.yml.
